...
import {
    ...
    CollectionModifyMetadataParams,
    CollectionModifyMetadataResponse,
    CollectionModifyPermissionsParams,
    CollectionModifyPermissionsResponse,
    CollectionRemoveParams,
    CollectionRemoveResponse,
    CollectionRenameParams,
    CollectionRenameResponse,
    CollectionSetInheritanceParams,
    CollectionSetInheritanceResponse,
    CollectionSetPermissionParams,
    CollectionSetPermissionResponse,
    CollectionStatParams,
    CollectionStatResponse,
    CollectionTouchParams,
    CollectionTouchResponse,
