...
export class DataObjectOperations {
    ...
    async remove(params: DataObjectRemoveParams): Promise<DataObjectRemoveResponse> {
        return this.client.post("/data-objects",
            toURLSearchParams({ op: "remove", ...params })
        )
    }

    async calculate_checksum(params: DataObjectCalculateChecksumParams): Promise<DataObjectCalculateChecksumResponse> {
        return this.client.post("/data-objects",
    ...
    // GET request
    async verify_checksum(params: DataObjectVerifyChecksumParams): Promise<DataObjectVerifyChecksumResponse> {
    ...
    async rename(params: DataObjectRenameParams): Promise<DataObjectRenameResponse> {
        return this.client.post("/data-objects",
    ...
    async replicate(params: DataObjectReplicateParams): Promise<DataObjectReplicateResponse> {
        return this.client.post("/data-objects",
    ...
    async register(params: DataObjectRegisterParams): Promise<DataObjectRegisterResponse> {
        return this.client.post("/data-objects",
    ...
    */
    ...
    async parallel_write_init(params: DataObjectParallelWriteInitParams): Promise<DataObjectParallelWriteInitResponse> {
        return this.client.post("/data-objects",
            toURLSearchParams({ op: "parallel_write_init", ...params })
        )
    }

    async parallel_write_shutdown(params: DataObjectParallelWriteShutdownParams): Promise<DataObjectParallelWriteShutdownResponse> {
        return this.client.post("/data-objects",
            toURLSearchParams({ op: "parallel_write_shutdown", ...params })
        )
    }

    async modify_metadata(params: DataObjectModifyMetadataParams): Promise<DataObjectModifyMetadataResponse> {
        return this.client.post("/data-objects",
            toURLSearchParams({ op: "modify_metadata", ...params })
        )
    }

    async set_permission(params: DataObjectSetPermissionParams): Promise<DataObjectSetPermissionResponse> {
        return this.client.post("/data-objects",
            toURLSearchParams({ op: "set_permission", ...params })
        )
    }

    async modify_permissions(params: DataObjectModifyPermissionsParams): Promise<DataObjectModifyPermissionsResponse> {
        return this.client.post("/data-objects",
            toURLSearchParams({ op: "modify_permissions", ...params })
        )
    }

    async modify_replica(params: DataObjectModifyReplicaParams): Promise<DataObjectModifyReplicaResponse> {
        return this.client.post("/data-objects",
